...
The order of variables matters: they must appear on the list in the order in which they're defined in the code.
...
fun main() {
    ...
    println("Please enter the number of habitat you would like to view:${animals[readln().toInt()]}")
    println("---")
